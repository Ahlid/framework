...
Domotico.prototype.hasConsola = function(nome) {
    return this.consolas.some(function(consola) { 
        return consola.nome == nome; 
    });
}
...
Domotico.prototype.criarConsola = function(nome) {
    ...
    var hasNomeConsola = this.consolas.some(function(consola) { 
        return consola.nome == nome;
    });
...
Consola.prototype.hasCompartimento = function(nome) {
    return this.compartimentos.some(function(compartimento) {
...
Consola.prototype.criarCompartimento = function(nome) {
    ...
    var hasNomeCompartimento = this.compartimentos.some(function(compartimento) {
        return compartimento.nome == nome;
    });
    ...
    return function(equipamentoImpactoLocal,tipoEquipamento,svgIconData) {
        ...
        this.referencia.onclick = function(e) {
            ...
            function criarOpcao(equipamento){
                ...
                opcao.value = equipamento !== void 0 ? equipamento.nome : 'undefined';
                equipamentosOpcoes[opcao.value] = equipamento !== void 0 ? equipamento : 'Não definido';
                
                var texto = document.createTextNode(equipamento !== void 0 ? equipamento.nome : 'Não definido');
            ...
            listaSensores.onblur = function(e) {
                ...
                if(listaSensores.value != 'undefined'){
                    ...
                    that.referencia.textContent = that.equipamento.nome + '>' + equipamentosOpcoes[listaSensores.value];
                }
    ...
    return function(detetorIncendio) {
        ...
        detetorIncendio.adicionarChangeListener(function(e) {
            ...
            if (detetorIncendio.acionado) {
                ...
                setTimeout(function() { clearInterval(intervalId); }, beepTempo);
